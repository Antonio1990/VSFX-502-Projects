...
#
# Started: 28 Jan 2013
# 15 Aug 2014 - RMS19/RIS ouputs .xml files that are now ignored.
# 27 May 2016 - ignoring ribs that end with "_edits.rib"
# 30 Nov 2016 - minor edit of lines 84 and 85
# Malcolm Kesson
import re, os, sys
			...
			if frame >= int(begin) and frame <= int(end):
				...
				for filename in os.listdir(framedir_path):
					...
					if filename.endswith('.zip'):
						...
						# may 2016
						# ignore ribs with this pattern,
						# perspShape_Final.0001_edits.rib
						if filepath.endswith('_edits.rib'):
							continue
